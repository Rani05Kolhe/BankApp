...
const Branding = () => {
  ...
  const onFinish = async (values) => {
    try {
      ...
      messageApi.success("Branding crated successfully");
        ...
        >
          ...
          >
            <div className="grid md:grid-cols-3 gap-x-3">
              ...
              <div className={`${brandings ? "hidden": "md:col-span-3 md:grid-cols-3 gap-x-3"}`}>
              <Item
              ...
              <Item
               label="Bank LinkedIn" name="bankLinkedIn">
                <Input type="url" />
              </Item>
